...
if (window.location.href.indexOf("kissanime.com/") == -1 && window.location.href.indexOf("kissanime.to/") == -1) {
	alert("You are not currently on KissAnime.");
	//fake function to cause script to terminate
	AbortJavaScript();
} else if (window.location.href.indexOf("kissanime.com/Anime/") == -1 && window.location.href.indexOf("kissanime.to/Anime/") == -1) {
